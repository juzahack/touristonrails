...
class PathsControllerTest < ActionController::TestCase
  ...
  test "should create path" do
    assert_difference('Path.count') do
      post :create, path: { date: @path.date, place: @path.place, trip: @path.trip, type: @path.type, weather: @path.weather }
    end
  ...
  test "should update path" do
    patch :update, id: @path, path: { date: @path.date, place: @path.place, trip: @path.trip, type: @path.type, weather: @path.weather }
    assert_redirected_to path_path(assigns(:path))
  end
